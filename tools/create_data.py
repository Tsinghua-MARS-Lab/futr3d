...
def nuscenes_data_prep(root_path,
    ...
    if version == 'v1.0-test':
        info_test_path = osp.join('data/', f'{info_prefix}_infos_test.pkl')
        nuscenes_converter.export_2d_annotation(
            root_path, info_test_path, version=version)
        return

    info_train_path = osp.join('data/', f'{info_prefix}_infos_train.pkl')
    info_val_path = osp.join('data/', f'{info_prefix}_infos_val.pkl')
    nuscenes_converter.export_2d_annotation(
